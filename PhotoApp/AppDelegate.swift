...
class AppDelegate: UIResponder, UIApplicationDelegate,CAAnimationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        self.window!.backgroundColor = UIColor(red: 25/255, green: 24/255, blue: 30/255, alpha: 1)
        ...
        navigationController.view.layer.mask?.contents = UIImage(named: "chrome-xxl-2")!.cgImage
        ...
        maskBgView.backgroundColor = UIColor(red: 252/255, green: 0/255, blue: 102/255, alpha: 1)
